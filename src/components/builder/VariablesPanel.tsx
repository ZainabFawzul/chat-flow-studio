...
const VARIABLE_TYPES = [
  { id: "boolean" as const, label: "True/False", icon: ToggleLeft },
    ...
    >
      <div className="p-3 border-b border-border">
        <p className="text-xs text-muted-foreground">
          Create variables to control response visibility and branching logic
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              {editingId === variable.id ? (
                ...
                <>
                  <span
                    className="flex-1 text-sm font-mono cursor-pointer hover:text-primary truncate"
...
export function VariablesTrigger({ onClick, variableCount }: VariablesTriggerProps) {
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
